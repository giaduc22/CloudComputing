<?php 
	...
	function getPrice($id)
	{
		...
		$result=mysql_query("select giatien from sanpham where mahang='$id'");
	...
	if(isset($_SESSION["hang"]))
	{
		...
		$result1=mysql_query("INSERT INTO `donhang` (`id`, `sanpham`, `username`, `ghichu`, `soluong`, `giaban`,`trangthai`,`diachi`) VALUES ".implode(",",$str_now));
