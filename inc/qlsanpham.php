...
<table width="725" border="1" background="">
	...
	<input name="Smsua" type="button" onclick="window.location='?action=themsanpham';" class="button-red muatiep" value="Thêm mới sản phẩm" />
  <tr>
...
?>
  <tr>
    ...
    <td><div align="left"><a href="?action=chitiet&id=<?php echo $rows['mahang']; ?>"><?php echo $rows['tenhang']; ?></a></div></td>
    ...
    <td><div align="left"><a href="?action=suasanpham&id=<?php echo "$rows[0]";?>">Sửa</a>&nbsp;&nbsp;
	<a href="exexoasp.php?id=<?php echo "$rows[0]";?>">Xóa</a></div></td>
  </tr>
 <?php
 }
 ?>
